...
class SM64World(World):
    ...
    slot_option_names = (
        ...
        "buddy_checks",
        "one_up_checks",
        "blocksanity_cap_blocks",
        "blocksanity_coin_blocks",
        "blocksanity_shell_blocks",
        "blocksanity_star_blocks",
        "blocksanity_one_up_blocks",
        "easy_butterflies",
        "no_despawns",
    ...
    def fill_slot_data(self):
        slot_data = {
            ...
            "BlocksanityCapBlocks": self.options.blocksanity_cap_blocks.value,
            "BlocksanityCoinBlocks": self.options.blocksanity_coin_blocks.value,
            "BlocksanityShellBlocks": self.options.blocksanity_shell_blocks.value,
            "BlocksanityStarBlocks": self.options.blocksanity_star_blocks.value,
            "BlocksanityOneUpBlocks": self.options.blocksanity_one_up_blocks.value,
